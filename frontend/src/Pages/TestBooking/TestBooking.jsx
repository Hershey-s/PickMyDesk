...
const TestBooking = () => {
  ...
  const runTests = async () => {
    ...
    try {
      ...
      if (
        results.tokenValid?.status === "success" &&
        results.workspaces?.firstWorkspace
      ) {
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8 bg-blue-50 p-6 rounded-lg">
          ...
          <ul className="space-y-2 text-blue-800">
            <li>
              • <strong>Not logged in?</strong> Go to{" "}
            ...
            <li>
              • <strong>Backend not running?</strong> Check if the backend
              server is started
            </li>
            <li>
              • <strong>Token invalid?</strong> Try logging out and logging back
              in
            </li>
            <li>
              • <strong>No workspaces?</strong> Run the seed data script
            </li>
          </ul>
        </div>
      </div>
